...
public final class ItemImageBinding implements ViewBinding {
  ...
  private ItemImageBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgView,
      @NonNull TextView tvImageName) {
  ...
  public static ItemImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemImageBinding((ConstraintLayout) rootView, imgView, tvImageName);
    }
