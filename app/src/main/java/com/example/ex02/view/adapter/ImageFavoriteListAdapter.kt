...
class ImageFavoriteListAdapter(private val imageRoomViewModel: ImageRoomViewModel) : ListAdapter<ItemImage, ImageFavoriteListAdapter.ImageViewHolder>(ImageDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: ImageViewHolder, position: Int) {
        ...
        holder.favoriteButton.setOnClickListener {
            deleteImageInFavoriteList(image)
        }
    }
